...
if(isset($_POST['update'])){
    ...
    $profile_pic = $staff['profile_pic']; // keep current picture by default
...
if(isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] === UPLOAD_ERR_OK){
    ...
    full_name='$full_name', username='$username', email='$email', profile_pic='$profile_pic'
    WHERE staff_id='$staff_id'";
        ...
        if(mysqli_query($link, $update_sql)){
            ...
            logAction($link, "Update", "Staff", $full_name, $admin_name);

            $success = "Staff updated successfully!";
            $staff = mysqli_fetch_assoc(mysqli_query($link, $sql)); // refresh
...
body.dark-mode form .submit-btn:hover {
...
<div style="margin-bottom:15px;">
    <img id="profilePreview" src="uploads/staff/<?php echo htmlspecialchars($staff['profile_pic'] ?: 'default.png'); ?>" 
         alt="Profile" width="100" height="100" style="border-radius:50%; object-fit:cover; display:block; margin-bottom:10px;">
    <input type="file" name="profile_pic" accept="image/*" onchange="previewProfile(event)">
        ...
        <button type="submit" name="update" class="submit-btn"><i class="fas fa-save me-2"></i> Update</button>
    </form>
</div>
